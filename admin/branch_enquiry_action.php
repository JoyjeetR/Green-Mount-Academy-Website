 ...
 * Redirects back to branch_enquiries.php, preserving filters.
 */
...
if ($id <= 0 || !in_array($action, ['delete', 'mark_contacted'])) {
    header('Location: branch_enquiries.php');
    exit;
}

// Build redirect URL preserving filters
$redirect = 'branch_enquiries.php';
$params = [];
if ($newFilter !== '') {
        ...
        <body>
            <div class="confirm-box">
                ...
                <div class="btn-group-confirm">
                    ...
                    <a href="branch_enquiry_action.php?action=delete&id=<?= $id ?>&confirm=yes&<?= http_build_query(array_filter([
                        'newFilter' => $newFilter,
